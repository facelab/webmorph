...
test_that("works", {
  ...
  expect_equal(temlist[[1]]$points - c(425, 375), ctems[[1]]$points)


  # squash
  ctems <- crop(temlist, 500, 600, squash = TRUE)
  ...
  expect_equal(temlist[[1]]$points - c(337.5, 0), ctems[[1]]$points)
})
